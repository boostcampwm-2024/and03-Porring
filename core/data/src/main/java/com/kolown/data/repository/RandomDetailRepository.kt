...
class FakeRandomDetailRepositoryImpl : RandomDetailRepository {
    private val mockData = listOf<ImageItem>(
        ImageItem(
            id=1,
    ...
    override fun getItem(currentPage : Int) : Flow<List<ImageItem>> = flow {
